  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'runtime/browser/android/xwalk_web_preferences_populater_impl.cc',
        'runtime/browser/android/xwalk_web_preferences_populater_impl.h',
        ...
        'runtime/browser/xwalk_web_preferences_populater.cc',
        'runtime/browser/xwalk_web_preferences_populater.h',
